...
def show_following(user_id):
    """Show list of people this u\er is following."""
...
def show_likes(user_id):
    """Show list of posts liked by the user."""
    ...
    likes = [like for like in g.user.likes]
    return render_template('users/likes.html', user_id=user_id, likes=likes)
...
def profile():
    ...
    user_vals = [current_user.username, current_user.email, current_user.image_url, current_user.bio]
    ...
    return render_template('users/edit.html', form=form, current_user=current_user, user_vals=user_vals)
